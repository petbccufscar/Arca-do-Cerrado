      ...
      <div class='corpo'>
        <div class='acessos'>
          ...
          <div class='acesso_mapa'>
            ...
            <button
              class='bto_acesso'
              onClick={() => this.props.history.push('/mapa')}
            >
              Acesse o mapa
            </button>
          </div>
          <div class='acesso_esp'>
            ...
            <button
              class='bto_acesso'
              onClick={() => this.props.history.push('/especies')}
            >
              Acesse o conteúdo
            </button>
          </div>
        ...
        <div class='apresentacao'>
          <div class='sobre_pomar'>
            ...
            <p class='text_apresen'>
              ...
              de nós pode fazer nossa parte, será bem-vindo/a a trabalhar
              conosco!
            </p>
          </div>
          <div class='faca_parte'>
            ...
            <p class='text_faca'>
              ...
              experiência, o que vale é a motivação! Se você imagina que um
              mundo mais cheio de vida para todos depende da melhoria das nossas
            ...
            <form class='contato' onSubmit={this.handleSubimit} method='post'>
              ...
              <label class='posi_msg'>
                <input class='camp_msg' placeholder='Mensagem'></input>
              </label>
